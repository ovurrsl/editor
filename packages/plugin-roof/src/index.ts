...
export const roofHostPanel = {
  ...
  description:
    'Derive the roof from the walls: masses, gable or hip by style and massing, sheds rising away from the street — seated on the plate with every wall told what it carries.',
...
export type { Pt, WallInput } from './geometry'
export {
  AUTO_ROOF,
  frontDirOfLevel,
  plateOfLevel,
