...
import { deleteProject, updateProjectName, updateProjectVisibility } from '../lib/projects/actions'
        ...
        <div className="space-y-6 py-4">
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <div className="text-sm text-muted-foreground">Visible to public viewers</div>
            </div>
            <Switch
              checked={showScansPublic}
