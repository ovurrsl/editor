...
export type UploadAssetResult = { success: true; url: string } | { success: false; error: string }

export type CreateUploadUrlResult =
  | { success: true; signedUrl: string; storageKey: string; assetId: string }
  | { success: false; error: string }

export type ConfirmUploadResult = { success: true; url: string } | { success: false; error: string }
